              ...
              >
                ...
                <div className="mb-2 lg:mb-8 hover:scale-105 transition-all duration-300">
                  ...
                  <div
                    className={`${
                      index === idx
                        ? "border-b-4 border-orange transition-all after:lg:w-5 after:lg:h-5 after:bg-triangle after:bg-no-repeat after:lg:block after:lg:left-[130px] after:lg:absolute after:lg:-bottom-6 relative"
